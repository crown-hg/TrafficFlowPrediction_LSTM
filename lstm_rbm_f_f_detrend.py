...
file_name = 'f_f_dtrend_lstm_rbm'
test_mre, test_mae, test_rmse = lstm_test(hidden_size, lstm_layer_num, max_epoch, dropout_keep_rate,
                                          train_x, train_y, test_x, test_y, flow_diff_min, flow_diff_max, file_name,
                                          train_y_aver=train_y_aver, test_y_aver=test_y_aver,  gpu_device=gpu_device)
